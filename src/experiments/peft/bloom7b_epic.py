...
from src.model import cls_load_epic, cls_load_tweeteval
...
PROMPT_TEMPLATE = Path('src/prompts/bloom_double_prompt.txt').read_text()
RESULT_PATH = Path('results/bloom7b_epic')
